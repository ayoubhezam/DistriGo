import {
  ...
  Camion, Chauffeur, Tournee,
} from "./types";

// ─── CAMIONS ──────────────────────────────────────────────────────────────────
export const CAMIONS: Camion[] = [
  { id: "cam1", nom: "Camion 01", immat: "16-001-213", marque: "Mercedes Sprinter", actif: true  },
  { id: "cam2", nom: "Camion 02", immat: "16-002-213", marque: "Renault Master",    actif: true  },
  { id: "cam3", nom: "Camion 03", immat: "16-003-213", marque: "Peugeot Boxer",     actif: false },
];

// ─── CHAUFFEURS ───────────────────────────────────────────────────────────────
export const CHAUFFEURS: Chauffeur[] = [
  { id: "ch1", nom: "Bensalem",  prenom: "Karim",  phone: "+213 661 111 222", actif: true  },
  { id: "ch2", nom: "Mekki",     prenom: "Sofiane", phone: "+213 662 333 444", actif: true  },
  { id: "ch3", nom: "Hadj Ali",  prenom: "Yacine",  phone: "+213 663 555 666", actif: true  },
];

// ─── TOURNÉES ─────────────────────────────────────────────────────────────────
export const TOURNEES: Tournee[] = [
  {
    id: "T-001", date: "2026-06-20",
    camionId: "cam1", camionNom: "Camion 01",
    chauffeurId: "ch1", chauffeurNom: "Karim Bensalem",
    statut: "terminee",
    heureDepart: "07:30", heureRetour: "17:45",
    chargement: [
    ...
    ventes: [
      {
        id: "TV-001", customerId: "c1", customerName: "Épicerie Benali",
        items: [
          { productId: "p1",  productName: "Eau Minérale Sidi Ali 1,5L", qty: 24, unitPrice: 4.50  },
          { productId: "p5",  productName: "Sucre Raffiné Cosumar 1kg",  qty: 10, unitPrice: 10.00 },
        ],
        total: 208.00, paiement: "cash", heure: "09:15",
      },
      {
        id: "TV-002", customerId: "c3", customerName: "Alimentation Raji",
        items: [
          { productId: "p4",  productName: "Huile de Tournesol Lesieur 2L", qty: 6,  unitPrice: 55.00 },
          { productId: "p15", productName: "Coca-Cola 1,5L",                qty: 12, unitPrice: 14.00 },
        ],
        total: 498.00, paiement: "credit", heure: "11:00",
      },
      {
        id: "TV-003", customerId: "c5", customerName: "Mini Market Idrissi",
        items: [
          { productId: "p1",  productName: "Eau Minérale Sidi Ali 1,5L", qty: 12, unitPrice: 4.50  },
          { productId: "p15", productName: "Coca-Cola 1,5L",             qty: 12, unitPrice: 14.00 },
          { productId: "p5",  productName: "Sucre Raffiné Cosumar 1kg",  qty: 5,  unitPrice: 10.00 },
        ],
        total: 272.00, paiement: "cash", heure: "13:30",
      },
    ],
    retours: [
      { productId: "p1",  productName: "Eau Minérale Sidi Ali 1,5L",    qtyCharge: 100, qtyVendu: 36, qtyRetour: 64 },
      { productId: "p4",  productName: "Huile de Tournesol Lesieur 2L", qtyCharge: 30,  qtyVendu: 6,  qtyRetour: 24 },
      { productId: "p5",  productName: "Sucre Raffiné Cosumar 1kg",     qtyCharge: 50,  qtyVendu: 15, qtyRetour: 35 },
      { productId: "p15", productName: "Coca-Cola 1,5L",                qtyCharge: 48,  qtyVendu: 24, qtyRetour: 24 },
    ],
    totalVentes: 978.00, totalCash: 480.00, totalCredit: 498.00, nbClients: 3,
  },
  {
    id: "T-002", date: "2026-06-20",
    camionId: "cam2", camionNom: "Camion 02",
    chauffeurId: "ch2", chauffeurNom: "Sofiane Mekki",
    statut: "en_cours",
    heureDepart: "08:00",
    chargement: [
      { productId: "p2",  productName: "Lait Centrale 1L",           qty: 60,  unitPrice: 7.20  },
      { productId: "p11", productName: "Pâtes Torti Barilla 500g",   qty: 80,  unitPrice: 11.00 },
      { productId: "p13", productName: "Café Nescafé Classic 200g",  qty: 20,  unitPrice: 68.00 },
    ],
    ventes: [
      {
        id: "TV-004", customerId: "c2", customerName: "Superette Alaoui",
        items: [
          { productId: "p2",  productName: "Lait Centrale 1L",         qty: 12, unitPrice: 7.20  },
          { productId: "p11", productName: "Pâtes Torti Barilla 500g", qty: 24, unitPrice: 11.00 },
        ],
        total: 350.40, paiement: "cash", heure: "09:45",
      },
    ],
    retours: [],
    totalVentes: 350.40, totalCash: 350.40, totalCredit: 0, nbClients: 1,
  },
];

// ─── CATEGORIES (shared between Products.tsx and POS.tsx) ────────────────────
